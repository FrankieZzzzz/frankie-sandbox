...
class RecommendedBlocks
{
	...
	public function __construct()
	{
		...
		$this->recommended_blocks = [
			...
			'edd' => [
				...
				'keywords' => ['digital store', 'payments', 'ecommerce'],
			],
			'monster_insights' => [
			...
			'rafflepress' => [
				...
				'keywords' => ['giveaway', 'contests'],
			],
			'sb_facebook_feed' => [
				'plugin' => 'custom-facebook-feed',
				'pro' => 'custom-facebook-feed-pro',
				'title' => 'Custom Facebook Feed',
				'keywords' => ['Facebook', 'Facebook feed', 'Facebook posts', 'Facebook account', 'Facebook page'],
			],
			'sb_instagram_feed' => [
				'plugin' => 'instagram-feed',
				'pro' => 'instagram-feed-pro',
				'title' => 'Custom Instagram Feed',
				'keywords' => ['Instagram', 'Instagram feed', 'Instagram photos', 'Instagram widget', 'Instagram gallery', 'social feed',],
			],
			'sb_reviews_feed' => [
				'plugin' => 'reviews-feed',
				'pro' => 'reviews-feed-pro',
				'title' => 'Custom Reviews Feed',
				'keywords' => ['Google reviews', 'reviews', 'testimonials', 'yelp', 'Google business',],
			],
			'sb_tiktok_feed' => [
				'plugin' => 'feeds-for-tiktok',
				'pro' => 'tiktok-feeds-pro',
				'title' => 'Custom TikTok Feeds',
				'keywords' => ['TikTok', 'TikTok feed', 'TikTok videos', 'TikTok account', 'TikTok widget',],
			],
			'sb_twitter_feed' => [
				'plugin' => 'custom-twitter-feeds',
				'pro' => 'custom-twitter-feeds-pro',
				'title' => 'Custom Twitter Feeds',
				'keywords' => ['Twitter', 'Twitter feed', 'X feed', 'Twitter widget', 'Custom Twitter Feed',],
			],
			'sb_youtube_feed' => [
				'plugin' => 'feeds-for-youtube',
				'pro' => 'youtube-feed-pro',
				'title' => 'Custom Youtube Feed',
				'keywords' => ['YouTube', 'YouTube feed', 'YouTube widget', 'YouTube channel', 'YouTube gallery',],
			],
			'sugar_calendar' => [
				'plugin' => 'sugar-calendar',
				'title' => 'Custom Calendar',
				'keywords' => ['event', 'calendar', 'sugar calendar'],
			],
			'wp_mail_smtp' => [
				'plugin' => 'wp-mail-smtp',
				'title' => 'Custom emails',
			...
			'wpcode' =>	[
				...
				'keywords' => ['code', 'css', 'functions', 'snippet'],
			],
			'wpforms' => [
				'plugin' => 'wpforms',
				'title' => 'Custom Form',
		...
		foreach ($this->recommended_blocks as $block => $info) {
			...
			if (! $is_free && ! $is_pro) {
				...
				if(is_dir($block_path)) {
					register_block_type(
						__DIR__ . '/build/' . strtolower($block),
						[
	...
	public function install_scripts()
	{
		...
		wp_localize_script('faux_js', 'fauxData', [
